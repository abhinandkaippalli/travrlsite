...
function OneWayTripFlights() {

    const [date, setDate] = useState(null);

  return (
    <div>
        <div className="search-box on row">
                <div className="form-fields col-md-3">
                ...
                <div className="form-fields col-md-2 calndr-icon">
                    <DatePicker className='form-control' id='from' name='from' dateFormat="dd/MM/yyyy" selected={date} minDate={new Date()} onChange={(date) => setDate(date)} showMonthDropdown
                ...
                <div className="form-fields col-md-2">
...
export default OneWayTripFlights