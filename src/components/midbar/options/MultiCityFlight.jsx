        ...
        <div className="search-box row multi-city-search" style={{display:"flex"}}>
                <div className="col-md-10">
                    ...
                    <div className="row mt-md-2">
                        ...
                        <div className="form-fields col-md-2 calndr-icon">
                            <DatePicker type="text" className="form-control date-multy-city" dateFormat="dd/MM/yyyy" selected={secondDate} minDate={new Date()} onChange={(date) => setSecondDate(date)} showMonthDropdown
                                useShortMonthInDropdown />
                            {/* <input type="text" className="form-control date-multy-city" /> */}
                            <span className="icon">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                        ...
                        <div className="form-fields">
                            <button className="btn add-trip fw-500 dark-blue-txt">Add Trip +</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-2">
                    <div className="form-fields">
                        <button className="btn btn-typ1 w-100 form-control">Search</button>
                    </div>
                </div>
            </div>
    </div>
